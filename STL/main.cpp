...
void main()
{
	...
	//При создании вектора обязательгол задают только тип хранимых элементов .
...
//резервирует столько вместительности , сколько мы хотим, если хотим больше чем есть на данный момент
	...
	//вектора(size)
	//это можно сделать в целях экономии памяти,если мы уверенны что вектор 
	//больше ничего не будет добовлять.
	vector_info(vec);
